    ...
    <form wire:submit="save">
        <div class="grid gap-4 mb-4 mt-sm:grid-cols-2">
            ...
            <div>
                ...
                @error('form.kategori') <span class="error text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>
            <div>
                ...
                @error('form.satuan') <span class="error text-red-500 text-sm">{{ $message }}</span> @enderror
            </div>
            <div>
