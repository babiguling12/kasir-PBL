<div>
        ...
        <div class="flex justify-between items-center py-4 px-4 mb-4 rounded-t border sm:mb-5 bg-gray-50 dark:bg-gray-900 antialiased relative shadow-md sm:rounded-lg overflow-hidden h-28">
            ...
            <button wire:click="export" class="py-2 px-3 flex items-center text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
