    ...
    <div
        ...
        <div class="w-full md:w-1/2">
            <form class="flex items-center">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" wire:model.live.rebounce.100ms="search" id="search-produk" name="search-produk"
        ...
        <div
            ...
            @if (auth()->user()->role === 'admin')
                <button type="button" wire:click="$dispatch('openModal', { component: 'modals.all-produk-modal' })"
                    ...
                    <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <td
                            ...
                            <div class="flex items-center space-x-4">
                                @if (auth()->user()->role == 'admin')
                                    <button type="button"
                                        wire:click="$dispatch('openModal', { component: 'modals.all-produk-modal', arguments: {produk: {{ $produk->id }} }})"
                                    ...
                                    <button type="button"
                                        wire:click="$dispatch('openModal', { component: 'data-delete', arguments: { model: 'Produk', id: {{ $produk->id }} } })"
