        ...
        <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
            <ul class="space-y-2">
                ...
                <li>
                    ...
                    <ul id="dropdown-laporan" class="{{ request()->multipleis('histori') ? '' : 'hidden' }} py-2 space-y-2">
                        <li>
        ...
        <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800">
            <ul class="space-y-2">
                ...
                <li>
                    ...
                    <ul id="dropdown-produk" class="{{ request()->multipleis('kategori', 'satuan', 'produk') ? '' : 'hidden'}} py-2 space-y-2">
                        <li>
                ...
                <li>
                    ...
                    <ul id="dropdown-stok" class="{{ request()->multipleis('stok-masuk', 'stok-keluar') ? '' : 'hidden' }} py-2 space-y-2">
                        <li>
                ...
                <li>
                    ...
                    <ul id="dropdown-laporan" class="{{ request()->multipleis('histori', 'laporan') ? '' : 'hidden' }} py-2 space-y-2">
                        <li>
                            <a href="{{ route('page.histori') }}"
                                class="{{ request()->is('histori') ? 'text-white bg-blue-700' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center p-2 pl-11 text-base font-medium  rounded-lg  group">Histori
                                Transaksi</a>
