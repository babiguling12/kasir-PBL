        ...
        <ul class="space-y-2">
            ...
            <li>
                ...
                <ul id="dropdown-produk" class="hidden py-2 space-y-2">
                    ...
                    <li>
                        <a href="/produk"
                            class="{{ request()->is('produk') ? 'text-white bg-blue-700' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center p-2 pl-11 text-base font-medium  rounded-lg  group">Semua Produk</a>
                    </li>
                </ul>
            </li>
            <li>
                ...
                <ul id="dropdown-stok" class="hidden py-2 space-y-2">
                    <li>
                        <a href="/stok-masuk"
                            class="{{ request()->is('stok-masuk') ? 'text-white bg-blue-700' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center p-2 pl-11 text-base font-medium  rounded-lg  group">Stok Masuk</a>
                    </li>
                    <li>
                        <a href="/stok-keluar"
                            class="{{ request()->is('stok-keluar') ? 'text-white bg-blue-700' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center p-2 pl-11 text-base font-medium  rounded-lg  group">Stok Keluar</a>
                    </li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul id="dropdown-laporan" class="hidden py-2 space-y-2">
                    <li>
                        <a href="/histori"
                            class="{{ request()->is('histori') ? 'text-white bg-blue-700' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center p-2 pl-11 text-base font-medium  rounded-lg  group">Histori Transaksi</a>
                    </li>
                    <li>
                        <a href="/laporan"
                            class="{{ request()->is('laporan') ? 'text-white bg-blue-700' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center p-2 pl-11 text-base font-medium  rounded-lg  group">Laporan Keseluruhan</a>
                    </li>
                </ul>
            </li>
            <li>
