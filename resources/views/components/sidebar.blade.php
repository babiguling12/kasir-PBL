            ...
            <ul class="space-y-2">
                <li>
                    <a href="{{ route('kasir.dashboard') }}"
                        class="{{ request()->is('dashboard/kasir') ? 'text-white bg-blue-700' : 'text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }} flex items-center p-2 text-base font-medium  rounded-lg  group">
                        <svg aria-hidden="true"
                            class="{{ request()->is('dashboard/kasir') ? 'text-white' : 'text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white' }} w-6 h-6  "
