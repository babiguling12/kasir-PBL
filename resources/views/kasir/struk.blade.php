...
<div class="printable-area">
        ...
        <tbody>
            @foreach($histori_detail as $detail)
                <tr>
                    ...
                    <td class="text-right">Rp {{ number_format($detail->qty * $detail->harga_barang, 0, ',', '.') }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <p class="text-center text-xs">Password Wifi : belanjaduluyuk</p>
</div>
...
@media print {
    ...
    .printable-area {
        width: 80mm; /* Lebar printer thermal */
        margin: 0;
        padding: 5mm;
